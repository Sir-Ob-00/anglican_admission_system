    ...
    <div className="min-h-full bg-white">
      ...
      <main className="mx-auto w-full max-w-[1100px] px-4 py-8 md:px-8">
        <Panel className="mt-6 p-6">
          <div className="text-lg font-semibold text-slate-900">Public exam not available</div>
          <div className="mt-2 text-sm text-slate-700">
            This public exam page was removed because the backend does not provide the required public exam endpoints.
          </div>
          <button
            type="button"
